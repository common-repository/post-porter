...
/**
 * Abstract POST_PORTER_Background_Process class.
 *
 * @abstract
 * @extends POST_PORTER_Async_Request
 */
abstract class POST_PORTER_Background_Process extends POST_PORTER_Async_Request {
