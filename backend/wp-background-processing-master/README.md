...
Extend the `POST_PORTER_Async_Request` class:

```php
class WP_Example_Request extends POST_PORTER_Async_Request {
...
Extend the `POST_PORTER_Background_Process` class:

```php
class WP_Example_Process extends POST_PORTER_Background_Process {
